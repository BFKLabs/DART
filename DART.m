...
for i = 1:length(sName)
    ...
    switch (sName{i})
        ...
        case {'External Files','Para Files'} % case is the test/parameter files
...
ProgressLoadbar('Closing Down DART Program...');
...
% closes the loadbar
hh = findall(0,'tag','__progressbar__');
if ~isempty(hh)
    arrayfun(@delete,hh)
end
