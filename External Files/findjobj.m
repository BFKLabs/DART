function [handles,levels,parentIdx,listing,allHandles] = findjobj(container,varargin) %#ok<*CTCH,*ASGLU,*MSNU,*NASGU,*CHARTEN,*STREMP,*SPRINTFN>
            ...
            for origHandleIdx = 1 : numel(origContainer)
                try
                    ...
                    try
                        ...
                        try; set(thisContainer,'Tooltip',newTooltip); end
                    end
    ...
    function warnInvisible(varargin)
        try
            if strcmpi(get(hFig,'Visible'),'off')
                ...
                drawnow; pause(0.01);
                [handles,levels,parentIdx,listing,allHandles] = findjobj(origContainer,varargin{:});
