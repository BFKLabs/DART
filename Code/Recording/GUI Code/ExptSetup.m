...
if (fIndex ~= 0)
    ...
    % ensures that the short-term stimuli durations is in seconds
...
sPara.Square = ...
        struct('sAmp',100,'tDurOn',tC,'tDurOff',tC,'tOfs',0,'nCount',nC);
sPara.Ramp = ...
        struct('sAmp0',0,'sAmp1',100,'tCycle',tC,'tOfs',0,'nCount',nC);
sPara.Triangle = ...
        struct('sAmp0',0,'sAmp1',100,'tCycle',tC,'tOfs',0,'nCount',nC);
sPara.SineWave = ...
        struct('sAmp0',0,'sAmp1',100,'tCycle',tC,'tOfs',0,'nCount',nC);
