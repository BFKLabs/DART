...
[iMx,jMx] = deal(argMax(ZxcGC),argMax(IxcGC));
...
% sets the coordinates of the best solution
...
IG = cellfun(@(x,y)(nanmean(x(y))),num2cell(I,1),num2cell(iBest,1));
IGC = cellfun(@(x)(nanmean(IG(x))),indC);
