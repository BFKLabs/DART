            ...
            if (isFull)
                ...
                if (~hasTool)                                         
                    if (isUtil)
                        ...
                        switch (finalDir)
                            case ('mmread') % case is the mmread directory
                                isCopy = true;
                            case {'xlwrite','poi_library'} % case is the mmread directory
                                isCopy = true;                            
                            case ('Test Files') % case is the test files
                                isCopy = true;
                            case ('Images') % case is the mmread directory
                                isCopy = true;                        
                            case ('Matlab')
                                isCopy = true; 
                            case ('Resources')
                            ...
                            case ('Para Files')
                                ...
                                isCopy = any(cellfun(@(x)(strcmp(x,copyData(i).name)),fName));
                            otherwise
