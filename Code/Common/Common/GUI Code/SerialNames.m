...
set(handles.buttonAddDevice,'enable','off')
set(handles.buttonRemoveDevice,'enable','off')
...
set(handles.buttonAddDevice,'enable',eStr{1+~isempty(nwStr)})
...
set(handles.buttonRemoveDevice,'enable',eStr{1+~isempty(iSel)})
...
set(handles.figDeviceNames,'visible','off'); pause(0.05)
...
set(handles.figDeviceNames,'visible','on'); 
