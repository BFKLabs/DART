...
%
srcDir = {fullfile(tmpDir,'DART Main'),fullfile(tmpDir,'Para Files'),...
          fullfile(tmpDir,'Test Main'),fullfile(tmpDir,'Analysis Functions')};
dstDir = {cDir,fullfile(cDir,'Para Files'),fullfile(cDir,'Test Files'),...
...
rmvAllFiles(fullfile(tmpDir,'Test Files'));
...
try; rmdir(fullfile(tmpDir,'Test Files')); end
