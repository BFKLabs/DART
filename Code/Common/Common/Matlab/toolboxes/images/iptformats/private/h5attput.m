...
switch class(attvalue)
	...
	otherwise 
		error(message('images:H5ATTPUT:unsupportedDatatype', class( attvalue )));
end
return
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if ~ischar(hfile)
	error(message('images:H5ATTPUT:badFilenameDatatype'));
end
...
if nargin == 3
    ...
    if isempty(slashes)
        error (message('images:H5ATTGET:badAttributePath', varname));
    elseif slashes == 1
...
if ~ischar(varname)
	error(message('images:H5ATTPUT:badVarnameDatatype'));
end

if ~ischar(attname)
	error(message('images:H5ATTPUT:badAttnameDatatype'));
end
