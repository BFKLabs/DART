...
case '1.2.840.10008.1.2.4.50'
    ...
    [fragments, frames] = dicom_encode_jpeg_lossy(pixel_cells, bits_allocated);
    fragments = padFragments(fragments);
...
case '1.2.840.10008.1.2.4.90'
    ...
    [fragments, frames] = dicom_encode_jpeg2000_lossless(pixel_cells, bits_allocated);
    fragments = padFragments(fragments);
    
case '1.2.840.10008.1.2.4.91'
    
    [fragments, frames] = dicom_encode_jpeg2000_lossy(pixel_cells, bits_allocated);
    fragments = padFragments(fragments);
