function tocspecializedoperations
% Specialized operations
% ----------------------
%   <a href="matlab:help buffer">buffer</a>     - Buffer a signal vector into a matrix of data frames
%   <a href="matlab:help cell2sos">cell2sos</a>   - Convert cell array to second-order-section matrix
%   <a href="matlab:help cplxpair">cplxpair</a>   - Order vector into complex conjugate pairs
%   <a href="matlab:help db2mag">db2mag</a>     - dB to magnitude conversion
%   <a href="matlab:help db2pow">db2pow</a>     - dB to power conversion
%   <a href="matlab:help demod">demod</a>      - Demodulation for communications simulation
%   <a href="matlab:help eqtflength">eqtflength</a> - Equalize the length of a discrete-time transfer function
%   <a href="matlab:help findpeaks">findpeaks</a>  - Find local peaks in data                                                                   
%   <a href="matlab:help mag2db">mag2db</a>     - Magnitude to dB conversion
...
%   <a href="matlab:help pow2db">pow2db</a>     - Power to dB conversion
%   <a href="matlab:help seqperiod">seqperiod</a>  - Find minimum-length repeating sequence in a vector
%   <a href="matlab:help sos2cell">sos2cell</a>   - Convert second-order-section matrix to cell array
