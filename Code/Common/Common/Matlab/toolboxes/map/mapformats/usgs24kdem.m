...
% structure array containg the B profiles. spatialResolution is a double
...
if isempty(gsize) 			
	...
	[rIndGrat,cIndGrat] = meshgrat( ...
        [min(readrows) max(readrows)],[min(readcols) max(readcols)],gsize);
end
