...
% is entered. Layers are specified as strings or a cell array of strings.
%
...
% Values may be integers, strings, or to match multiple values, cell arrays
% of integers or strings.
%
%  For details on locating map data for download over the Internet, see the
%  following documentation at the MathWorks web site:
%
%  <a href="matlab:
...
elseif ischar(topolevel)
    ...
    validateattributes(topolevel, {'char', 'cell'}, {'nonempty'}, ...
        'vmap0data', 'topolevel')
...
function struc = vmap0txttl(themepath,~,struc,cVDT,FTfilename,ET,SYM,property)
