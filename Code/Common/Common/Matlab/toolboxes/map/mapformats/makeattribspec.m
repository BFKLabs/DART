...
%   the first column and the string value of the attribute in the second
%   column.  You can modify ATTRIBSPEC, then pass it to KMLWRITE to exert
%   control over which attribute fields are written to the HTML table and
%   the format of the string conversion.
%
...
%                      attribute field in S. With KMLWRITE, the string is
%                      used to label the attribute in the first column of
%                      the HTML table. The string may be modified prior to
%                      calling KMLWRITE.  You might modify an attribute
