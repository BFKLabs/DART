...
%   Map data from a number of external data files. DEMDATAUI reads ETOPO5,
%   TerrainBase, GTOPO30, GLOBE, satellite bathymetry and DTED data. See
%   the links under 'See also' for more information on these datasets.
%   DEMDATAUI looks for these external data files on the MATLAB path and,
%   for some operating systems, on CD-ROM disks. Click the HELP button for
%   more information on use of the GUI and how DEMDATAUI recognizes data
%   sources.
%
...
coast = load('coast');
hold on
geoshow(coast.lat, coast.long, 'Color',.65*[1 1 1], 'Parent', h.axes);
clear coast
