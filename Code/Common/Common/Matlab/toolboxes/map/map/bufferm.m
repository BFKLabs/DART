...
%   direction string, BUFFERM uses 'out' as the default and returns a
%   buffer zone outside the polygon. If you supply 'in' as the direction
%   string, BUFFERM returns a buffer zone inside the polygon. If you are
...
if strcmp(direction,'in')
    ...
    if ~isempty(firstClosed)
        ...
        if strcmp(direction,'out')
            ...
            [lonc, latc] = polybool('union', lonc, latc, lona, lata);
        end
    end
