...
%
%   Feature properties:
%      Feature properties provide one value (a scalar number or a string)
%      for each feature in the mappoint vector. They are suitable for
%      properties that describe a single element of a mappoint vector. The
%      X and Y properties are feature properties since they contain one
...
%   Example 4
%   ---------
%   % Construct a mappoint vector to hold the coordinates
%   % from the seamount MAT-file. Add a dynamic feature property
%   % property to indicate the Z coordinate. Add a dynamic 
%   % feature property to indicate a binned level value
%   % and a color value for a given level. 
%   % Include metadata information from the MAT-file.
%
...
classdef mappoint < map.internal.DynamicVector 
    ...
    methods
        ...
        %   S is not scalar.
        %
        %   The remaining fields of S become dynamic properties of P. Field
        %   values in S that are not numeric vectors or strings or cell
        %   arrays of string values are ignored.
        %
