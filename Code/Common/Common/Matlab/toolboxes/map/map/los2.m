function varargout = los2(map, R, lat1, lon1, lat2, lon2, ...
...
if numel(lat1) == 1
    ...
    visprofile = losprofile(dist, z, oalt, talt, ...
                               oaltopt, taltopt, apparentradius, makeplot);
...
outputArguments = {vis,visprofile,dist,z,lattrk,lontrk};
...
[lat,lon] = doInterpm(lat, lon, 0.9/sampleDensity(R), 'gc', 'degrees');
...
function vis = losprofile(...
    rng, zin, oalt, talt, oaltopt, taltopt, apparentradius, makeplot)
