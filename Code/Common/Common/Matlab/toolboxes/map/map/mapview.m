...
%   you must re-select the appropriate tool.  Use the "Select annotations"
%   tool and Edit menu to modify or remove your annotations. The Map Viewer
%   manages annotations separately from data layers; annotations always
%   stay on top.  Note that annotations cannot be saved, although they
%   appear on a map exported to an image format, as described below.
%
