...
%   the string ANGLEUNITS to determine the units of the angle-values inputs
...
% 
%   [LAT,LON] = SCIRCLE1(TRACKSTR,...) uses the string TRACKSTR to define
...
[latc,lonc] = reckon(str,biglat,biglon,bigrng,az,ellipsoid,'radians');
