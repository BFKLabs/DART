...
%
%   See also maprasterref, map.rasterref.GeographicCellsReference, map.rasterref.GeographicPostingsReference
...
elseif ischar(varargin{1})
    ...
    [rasterInterpretation, pairs] = internal.map.findNameValuePair( ...
