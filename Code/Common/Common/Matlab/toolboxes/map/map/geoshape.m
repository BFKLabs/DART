...
%
%   Vertex properties:
%      Vertex properties provide a scalar number or a string for each
%      vertex in a geoshape object. Vertex properties are suitable for
...
%      for each feature in a geoshape vector. They are suitable for
...
%   coast = load('coast');
%   shape = geoshape(coast.lat, coast.long);
%
...
%   figure
%   worldmap world
%   geoshow(shape.Latitude, shape.Longitude)
%
%   Example 2
%   ---------
%   % Construct a geoshape vector for two point features from
...
classdef geoshape < map.internal.DynamicShape
    ...
    methods
        ...
        %   properties. Field values in S that are not numeric vectors or
        %   strings or cell arrays of numeric or string values are ignored.
        %
