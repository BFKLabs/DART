...
%   [LAT,LON] = TRACK2(LAT1,LON1,LAT2,LON2,ELLIPSOID,ANGLEUNITS) use the
%   ANGLEUNITS string to determine the units of the angle-valued inputs
%   and outputs.
% 
...
% 
%   [LAT,LON] = TRACK2(TRACKSTR,...) uses the string TRACKSTR to specify
