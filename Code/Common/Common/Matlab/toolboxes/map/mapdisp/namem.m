...
%   Tag string, if non-empty, and the value of its Type otherwise. The
%   output NAMES is a character matrix with duplicate object names removed.
%
%   NAMES = NAMEM(H) returns the names of the objects specified by
%   an array of Handle Graphics objects handles in H.
%
%   Note: Use cellstr(NAMES) to convert NAMES to a cell array of strings.
%
