...
%     otherwise.
%
%   See also geocentricLatitude, geodeticLatitudeFromParametric, map.geodesy.AuthalicLatitudeConverter, map.geodesy.ConformalLatitudeConverter, map.geodesy.IsometricLatitudeConverter, map.geodesy.RectifyingLatitudeConverter
