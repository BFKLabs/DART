function [xEast, yNorth, zUp] = ecef2enu( ...
...
%   length unit as the spheroid.  Outputs xEast, yNorth, and zUp will be
%   expressed in this unit, also.  The input latitude and longitude angles
%   are in degrees by default.
%
%   [...] = ECEF2ENU(..., angleUnit) uses the string angleUnit, which
...
%      float: double, single
%
%   See also ECEF2NED, ECEF2AER, ENU2ECEF, GEODETIC2ENU
