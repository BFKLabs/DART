...
%
%   ELLIPSOID = UTMGEOID(ZONE) uses the ZONE string (e.g., '47N') to select
%   the recommended ellipsoid definition(s).  If the zone string is purely
...
% Use the utmzone function to validate the ZONE string.
zone = upper(zone);
utmzone(zone);
