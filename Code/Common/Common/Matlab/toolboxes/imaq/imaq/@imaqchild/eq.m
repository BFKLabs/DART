...
try   
    ...
    % Make sure that the imaqchild object is always arg1.
    if ~isa(arg1, 'imaqchild')
        [arg1 arg2] = deal(arg2, arg1);
    end
    
    % Now we know that arg1 is imaqchild object.  If arg2 is not an
    % imaqchild object, then there is no way that the objects are equal.
    if ~isa(arg2, 'imaqchild')
