classdef (Hidden) AnalogInputVoltageChannel < daq.ni.AnalogInputVoltageChannel & daq.ni.CompactDAQ.CommonAIChannelAttrib
    %AnalogInputVoltageChannel All settings & operations for an NI CompactDAQ analog input voltage channel.
    ...
    methods (Sealed, Access = protected)
        ...
        function channelPropertyBeingChangedHook(obj,propertyName,newValue)
            ...
            obj.channelPropertyBeingChangedHook@daq.ni.AnalogInputVoltageChannel(propertyName,newValue);
