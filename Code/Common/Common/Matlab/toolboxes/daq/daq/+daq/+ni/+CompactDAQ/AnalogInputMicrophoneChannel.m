classdef (Hidden) AnalogInputMicrophoneChannel < daq.ni.AnalogInputMicrophoneChannel & daq.ni.CompactDAQ.CommonAIChannelAttrib
% classdef (Hidden) AnalogInputMicrophoneChannel
    %CompactDAQAnalogInputMicrophoneChannel All settings & operations
    %for an NI CompactDAQ analog input microphone channel.
    ...
    methods(Hidden)
        function obj = AnalogInputMicrophoneChannel(session,deviceInfo,channelID)
            ...
            %operations for a CompactDAQ analog input microphone channel
            %added to a session.
    ...
    methods(Hidden)
        ...
        function configureTask(obj,taskHandle)
            obj.configureTask@daq.ni.AnalogInputMicrophoneChannel(taskHandle);
    ...
    methods (Sealed, Access = protected)
        ...
        function channelPropertyBeingChangedHook(obj,propertyName,newValue)
            ...
            obj.channelPropertyBeingChangedHook@daq.ni.AnalogInputMicrophoneChannel(propertyName,newValue);
