classdef (Hidden) AnalogInputVoltageChannel < daq.ni.AnalogInputVoltageChannel & daq.ni.DSACommonChannelAttrib
    %AnalogInputVoltageChannel All settings & operations for a  NI PCI DSA
    ...
    methods(Hidden)
        function obj = AnalogInputVoltageChannel(session,deviceInfo,channelID)
            %AnalogInputVoltageChannel All settings & operations for a PCI DSA analog input voltage channel added to a session.
