classdef (Hidden) AnalogInputThermocoupleChannel < daq.ni.AnalogInputThermocoupleChannel & daq.ni.CompactDAQ.CommonAIChannelAttrib
    %AnalogInputThermocoupleChannel All settings & operations for an NI CompactDAQ analog input thermocouple channel.
    ...
    methods(Hidden)
        function obj = AnalogInputThermocoupleChannel(session,deviceInfo,channelID)
            %AnalogInputThermocoupleChannel All settings & operations for a CompactDAQ analog input thermocouple channel added to a session.
            ...
            obj@daq.ni.AnalogInputThermocoupleChannel(session,deviceInfo,channelID);
    ...
    methods(Hidden)
        ...
        function configureTask(obj,taskHandle)
            obj.configureTask@daq.ni.AnalogInputThermocoupleChannel(taskHandle);
    ...
    methods (Sealed, Access = protected)
        ...
        function channelPropertyBeingChangedHook(obj,propertyName,newValue)
            ...
            obj.channelPropertyBeingChangedHook@daq.ni.AnalogInputThermocoupleChannel(propertyName,newValue);
