...
%    $Revision: 1.3.2.10 $  $Date: 2009/12/31 18:44:44 $
...
parent_obj(find(parent_obj == ' ')) = []; %#ok<FNDSB>
...
try
   daqgate('privatewritechild',fid,syntax,definelist,obj,testobj,name,...
...
fprintf(fid,['%%' upper(file) ' MATLAB Code for creating an array of ' type_child ' objects.\n',...
      '%%    \n',...
      ...
      '%%    the ' type_child ' object, type the name of the file, ' upper(file),...
             ', at the MATLAB \n',... 
      '%%    command prompt and pass a PARENT object as input.  The PARENT object\n',... 
      '%%    should be of class ''' parent_obj '''.\n',...
      '%%    \n',...
      '%%    The file, ' upper(file) ', must be on your MATLAB PATH.  For additional\n',...
