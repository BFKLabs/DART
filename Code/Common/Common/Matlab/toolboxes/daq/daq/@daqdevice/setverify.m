...
%    $Revision: 1.8.2.7 $  $Date: 2008/06/16 16:35:20 $
...
try
     % Turn off warnings for samplerate/inputrange/outputrange when using the
   % SETVERIFY command (geck 239737)
   sampleRate = warning('off', 'daq:set:sampleRateMismatch');
...
throwAsCaller(MException('daq:setverify:unexpected',errmsg))      
