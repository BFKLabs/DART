...
%   use the string ANGLEUNITS to specify the angle units of the inputs and
...
%
%   [LAT,LON] = ELLIPSE1(TRACKSTR,...) uses the string TRACKSTR to define
%   either a great circle or rhumb line distances from the ellipse center.
%   If TRACKSTR is 'gc', then great circle distances are computed (the
