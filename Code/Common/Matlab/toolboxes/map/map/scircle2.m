...
%   [LAT,LON] = SCIRCLE2(LAT1,LON1,LAT2,LON2,ELLIPSOID,ANGLEUNITS) use the
%   string ANGLEUNITS to determine the units of the angle-valued inputs and
...
% 
%   [LAT,LON] = SCIRCLE2(TRACKSTR,...) uses the TRACKSTR string to define
