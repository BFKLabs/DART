...
%   latitude type strings listed below (or unambiguous abbreviations).
...
%            referenceEllipsoid, RSPHERE, wgs84Ellipsoid.
...
%--------------------------------------------------------------------------
function latout = geocentric2geodetic(e,latin,~)
latout = geocentric2geodeticLat(e, latin);

%--------------------------------------------------------------------------
function latout = geodetic2geocentric(e,latin,~)
latout = geodetic2geocentricLat(e, latin);
