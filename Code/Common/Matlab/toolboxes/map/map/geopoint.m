...
%      for each feature in the geopoint vector. They are suitable for
%      properties that describe a single element of a geopoint vector. The
%      Latitude and Longitude properties are feature properties since they
%      contain one value for each feature.
%
...
%   geoshow(p.Latitude, p.Longitude, 'DisplayType', p.Geometry)
%
%   Example 6
%   ---------
...
classdef geopoint < map.internal.DynamicVector 
    ...
    methods
        ...
        %   properties. Field values in S that are not numeric or strings
        %   or cell arrays of numeric or string values are ignored.
        %
