...
% used to construct base maps, or in applications or analyses that involve
% operations like geographic searches or the statistical properties of
% coastlines.

% Copyright 2005-2012 The MathWorks, Inc.

%% Step 1: Define a Working Folder
% This example creates several temporary files and uses the variable
% |workingFolder| to denote their location.  The value used here is
...
% GSHHS is available in wide range of spatial resolutions.  This example uses
% the lowest-resolution data, from the binary file |gshhs_c.b|.  A GNU
% zipped copy of this file is included in the Mapping Toolbox(TM) data
% folder, on the MATLAB path.
%
% Use the MATLAB |gunzip| function to decompress |gshhs_c.b.gz| and create
% the file |gshhs_c.b| in the location indicated by |workingFolder|.
% Then create an index file, |gshhs_c.i|, in the same folder.  In
...
% This example manipulates the top two levels of the GSHHS hierarchy,
...
% |'CrossesGreenwich'|, have been truncated to 11 characters. This
...
%%
% Optionally, remove the new shapefiles from your working folder.
% (This example needs to clean up after itself; in a real application you
