...
%  GRAY, HSV, HOT, PINK, COOL, BONE, JET, COPPER, SPRING, SUMMER, AUTUMN,
%  WINTER, FLAG and PRISM allow selection of standard colormaps.
...
if nargin < 1
    ...
    if matlab.graphics.internal.isGraphicsVersion1
        validateattributes(f,{'double'},{'scalar'},'','h')
    else
...
maps = {'Gray','Hsv','Hot','Pink','Cool','Bone','Jet',...
...
h.sizelabel = uicontrol(h.fig,'Style','Text','String','Colormap Size (optional):', ...
    ...
    'Tag', 'sizelabel','FontWeight','bold','FontSize',FontScaling*10, ...
    'HorizontalAlignment','left', ...
...
h.sizelist = uicontrol(h.fig,'Style','Push','String', 'List', ...
    ...
    'Tag','sizelist','FontWeight','bold','FontSize',FontScaling*9, ...
    'ForegroundColor','black','BackgroundColor',figclr,...
...
h.apply = uicontrol(h.fig,'Style','Push','String', 'Apply', ...
    ...
    'Tag','applybtn','FontWeight','bold','FontSize',FontScaling*10,...
    'HorizontalAlignment','center',...
    'ForegroundColor','black','BackgroundColor',figclr,...
    'CallBack','uiresume');
...
h.cancel = uicontrol(h.fig,'Style','Push','String', 'Cancel', ...
    ...
    'Tag','cancelbtn','FontWeight','bold','FontSize',FontScaling*10, ...
    'HorizontalAlignment','center', ...
    'ForegroundColor','black','BackgroundColor',figclr,...
    'CallBack','uiresume');
