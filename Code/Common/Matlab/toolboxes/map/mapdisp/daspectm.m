...
%   distortion. The string 'zunits' specifies the units of the elevation
%   data, and can be any length units string recognized by UNITSRATIO.
%
...
%   determine the radius of the sphere.  RADIUS can be one of the strings
