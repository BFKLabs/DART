...
%     otherwise.
%
%   See also geodeticLatitudeFromGeocentric, parametricLatitude, map.geodesy.AuthalicLatitudeConverter, map.geodesy.ConformalLatitudeConverter, map.geodesy.IsometricLatitudeConverter, map.geodesy.RectifyingLatitudeConverter
