function out = privatePropDesc(propname,classtype)
...
%    $Revision: 1.19.2.17 $  $Date: 2011/10/31 06:07:11 $

% Check if the property is valid for the specified object type.
if ~isempty(classtype)
    localValidProp(propname, classtype);
end

% Create display or error.
out = localDisplay(lower(propname));

%******************************************************************
% Determine if the property is valid.
function localValidProp(propname, classtype)
...
if ~strcmp(classtype, validtype)
    error('daq:privatePropDesc:invalidproperty',...
        'Invalid property: ''%s.%s''.', classtype, propname)
end


%******************************************************************
% Create the display for each property.
function out = localDisplay(propname)
...
switch propname
    ...
    case 'channelskew'
        out = sprintf(['\n    CHANNELSKEW  double\n\n',...
            ...
            '    ChannelSkew value is 0. SS/H hardware includes sound cards.',...
            '    \n\n',...
    ...
    case 'datamissedfcn'
        out = sprintf(['\n    DATAMISSEDFCN  string, function_handle, or cell array\n\n',...
            '    DataMissedFcn specifies the function to execute when data is missed.\n\n',...
            '    A data-missed event is generated immediately after acquired data is missed.\n',...
            '    This event executes the function specified for DataMissedFcn.\n\n',...
    ...
    case 'eventlog'
        out = sprintf(['\n    EVENTLOG  structure array  (read only)\n\n',...
            ...
            '    events. Additionally, input over-range and data missed events are stored for\n',...
    ...
    case 'hwchannel'
        out = sprintf(['\n    HWCHANNEL  double\n\n',...
            ...
            '    hardware, channel IDs are zero-based (begin at zero). For sound cards, channel \n',...
            '    IDs are one-based (begin at one).\n\n',...
            '    For scanning hardware, the scan order follows the MATLAB index. Therefore,\n',...
            '    the hardware channel associated with index 1 is sampled first, the hardware\n',...
    ...
    case 'index'
        out = sprintf(['\n    INDEX  double  (read only)\n\n',...
            ...
            '    Index provides a convenient way to programmatically access channel and line\n',...
            '    indices.\n\n',...
    ...
    case 'inputoverrangefcn'
        out = sprintf(['\n    INPUTOVERRANGEFCN  string, function_handle, or cell array\n\n',...
            '    InputOverRangeFcn specifies the function to be executed when data sampled\n',...
    ...
    case 'inputrange'
        out = sprintf(['\n    INPUTRANGE  double\n\n',...
            ...
            '    If an input signal exceeds the InputRange value, then an over-range condition\n',...
            '    occurs. Over-range detection is enabled only if the analog input object is\n',...
    ...
    case 'inputsource'
        out = sprintf(['\n    INPUTSOURCE  [ {SwitchBox} | CALIN | Ground | BOBCALIN ] \n\n',...
            ...
            '    additional input modes are available. These additional input modes are\n',...
    ...
    case 'inputtype'
        out = sprintf(['\n    INPUTTYPE  device specific\n\n',...
            ...
            '    NonReferencedSingleEnded.  For Measurement Computing and Advantech boards, \n',...
            '    InputType must be set from the vendor configuration tool, and is read-only\n',...
            '    from within the Data Acquisition Toolbox.\n\n',...
    ...
    case 'manualtriggerhwon'
        out = sprintf(['\n    MANUALTRIGGERHWON [ {Start} | Trigger ]\n\n', ...
            '    ManualTriggerHwOn controls when the hardware will actually start when a manual\n', ...
            '    trigger is used.  PeekData and pretrigger are not available when this setting\n', ...
            '    is used.\n']);
    ...
    case 'outofdatamode'
        out = sprintf(['\n    OUTOFDATAMODE  [ {Hold} | DefaultValue ]\n\n',...
            ...
            '    National Instruments and Measurement Computing devices, the last value is \n',...
    ...
    case 'repeatoutput'
        out = sprintf(['\n    REPEATOUTPUT  double\n\n',...
            ...
            '    data using RepeatOutput. Since RepeatOutput re-queues the data, additional\n',...
    ...
    case 'runtimeerrorfcn'
        out = sprintf(['\n    RUNTIMEERRORFCN  string, function_handle, or cell array\n\n',...
            ...
            '    This event executes the function specified for RuntimeErrorFcn. The default\n',...
    ...
    case 'samplesacquiredfcn'
        out = sprintf(['\n    SAMPLESACQUIREDFCN  string, function_handle, or cell array\n\n',...
            '    SamplesAcquiredFcn specifies the function to execute every time\n',...
            ...
            '    for each channel group member. This event executes the function specified for\n',...
            '    SamplesAcquiredFcn.\n\n',...
    ...
    case 'samplesacquiredfcncount'
        out = sprintf(['\n    SAMPLESACQUIREDFCNCOUNT  double\n\n',...
            ...
            '    channel group member. This event executes the function specified by the\n',...
    ...
    case 'samplesoutputfcn'
        out = sprintf(['\n    SAMPLESOUTPUTFCN  string, function_handle, or cell array\n\n',...
            '    SamplesOutputFcn specifies the function to execute every time\n',...
            ...
            '    channel group member. This event executes the function specified for\n',...
            '    SamplesOutputFcn.\n\n',...
    ...
    case 'samplesoutputfcncount'
        out = sprintf(['\n    SAMPLESOUTPUTFCNCOUNT  double\n\n',...
            ...
            '    member. This event executes the function specified by the SamplesOutputFcn\n',...
            '    property.\n\n',...
    ...
    case 'standardsamplerates'
        out = sprintf(['\n    STANDARDSAMPLERATES  [ {On} | Off ] \n\n',...
            ...
            '    sample rate can be set to any value within the allowed bounds (if\n',...
    ...
    case 'startfcn'
        out = sprintf(['\n    STARTFCN  string, function_handle, or cell array\n\n',...
            ...
            '    When the StartFcn has finished executing, Running is automatically\n',...
    ...
    case 'stopfcn'
        out = sprintf(['\n    STOPFCN  string, function_handle, or cell array\n\n',...
            '    StopFcn specifies the function to execute just after the device\n',...
            '    object and hardware device stop executing. \n\n',...
            '    A stop event is generated immediately after the STOP command is issued. This\n',...
            '    event executes the function specified for StopFcn.\n\n',...
            '    Under most circumstances, the function is not guaranteed to complete execution\n',...
    ...
    case 'timeout'
        out = sprintf(['\n    TIMEOUT  double\n\n',...
            ...
            '    a timeout occurs, the function specified by RuntimeErrorFcn is\n',...
            '    called.\n\n',...
    ...
    case 'timerfcn'
        out = sprintf(['\n    TIMERFCN  string, function_handle, or cell array\n\n',...
            '    TimerFcn specifies the function to execute whenever a predefined\n',...
            '    period of time passes.\n\n',...
            '    A timer event is generated whenever the time specified by the TimerPeriod\n',...
            '    property passes. This event executes the function specified for TimerFcn. Time\n',...
    ...
    case 'triggerfcn'
        out = sprintf(['\n    TRIGGERFCN  string, function_handle, or cell array\n\n',...
            '    TriggerFcn specifies the function to be executed when a trigger occurs.\n',...
            '    A trigger event is generated immediately after a trigger is executed. \n',...
            '    This event executes the function specified for TriggerFcn. Under most \n',...
            '    circumstances, the function is not guaranteed to complete execution until \n',...
    ...
    case 'triggerdelayunits'
        out = sprintf(['\n    TRIGGERDELAYUNITS  [ {Seconds} | Samples ]\n\n',...
            '    TriggerDelayUnits specifies the units in which trigger delay data \n',...
            '    is measured.\n\n',...
    ...
    case 'transfermode'
        out = sprintf(['\n    TRANSFERMODE  device specific\n\n',...
            ...
            '    and Advantech devices, TransferMode can be Default, InterruptPerPoint,\n',...
