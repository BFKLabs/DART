classdef (Hidden) AnalogInputAccelerometerChannel < daq.ni.AnalogInputAccelerometerChannel & daq.ni.DSACommonChannelAttrib
    % classdef (Hidden) AnalogInputAccelerometerChannel
    %AnalogInputAccelerometerChannel All settings & operations for an NI
    %PXI DSA analog input accelerometer channel.The DSACommonChannelAttrib
    %provides the common functionality for all DSA devices.
    ...
    methods(Hidden)
        function obj = AnalogInputAccelerometerChannel(session,deviceInfo,channelID)
            ...
            %operations for a NI PXI analog input accelerometer channel
            %added to a session.
