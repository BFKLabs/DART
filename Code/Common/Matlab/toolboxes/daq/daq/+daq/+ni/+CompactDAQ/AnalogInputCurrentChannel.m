classdef (Hidden) AnalogInputCurrentChannel < daq.ni.AnalogInputCurrentChannel & daq.ni.CompactDAQ.CommonAIChannelAttrib
    %AnalogInputCurrentChannel All settings & operations for an NI CompactDAQ analog input current channel.
    ...
    methods(Hidden)
        function obj = AnalogInputCurrentChannel(session,deviceInfo,channelID)
            %AnalogInputCurrentChannel All settings & operations for a CompactDAQ analog input current channel added to a session.
            ...
            obj@daq.ni.AnalogInputCurrentChannel(session,deviceInfo,channelID);
    ...
    methods(Hidden)
        ...
        function configureTask(obj,taskHandle)
            obj.configureTask@daq.ni.AnalogInputCurrentChannel(taskHandle);
    ...
    methods (Sealed, Access = protected)
        ...
        function channelPropertyBeingChangedHook(obj,propertyName,newValue)
            ...
            obj.channelPropertyBeingChangedHook@daq.ni.AnalogInputCurrentChannel(propertyName,newValue);
