classdef (Hidden) AnalogInputIEPEChannel < daq.ni.AnalogInputIEPEChannel & daq.ni.DSACommonChannelAttrib
    ...
    %AnalogInputIEPEChannel All settings & operations for an NI PXI DSA
    ...
    methods(Hidden)
        function obj = AnalogInputIEPEChannel(session,deviceInfo,channelID)
            ...
            %added to a session.
            %    AnalogInputIEPEChannel(SESSION,DEVICEINFO,CHANNELID)
            %    Create a analog channel with SESSION, DEVICEINFO, and
            %    CHANNELID (see daq.Channel)
