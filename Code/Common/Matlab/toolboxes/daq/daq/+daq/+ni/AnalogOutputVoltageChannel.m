classdef (Hidden) AnalogOutputVoltageChannel < daq.AnalogOutputVoltageChannel & daq.ni.NICommonChannelAttrib
    %AnalogOutputVoltageChannel All settings & operations for an NI analog output voltage channel added to a session.
    ...
    methods(Hidden)
       ...
       function createChannelAndCaptureParameters(obj,taskHandle)
           obj.createChannel(taskHandle)
           obj.captureAnalogOutputVoltageParametersFromNIDAQmx(taskHandle)
       end
       
       function captureAnalogOutputVoltageParametersFromNIDAQmx(obj,taskHandle)
           % Capture the output type, get it from NI-DAQmx
