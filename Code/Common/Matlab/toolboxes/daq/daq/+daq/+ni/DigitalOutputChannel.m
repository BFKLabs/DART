classdef (Hidden) DigitalOutputChannel < daq.ni.DigitalChannel
    %DigitalInputChannel All settings & operations for an NI digital output
    %channel.
    ...
    methods(Hidden)
        function obj = DigitalOutputChannel(session,deviceInfo,channelID)
            ...
            %    Create a digital output channel with SESSION, DEVICEINFO,
            ...
            obj.Direction = char(daq.Direction.Output);
        ...
        function channelDescriptionText = getChannelDescriptionHook(~)
                channelDescriptionText = 'digital output channel';
        end
    end
    ...
    methods
        function set.Direction(obj,newDirection)
            ...
            obj.localizedError('daq:Channel:readOnlyPropertyForChannelByMeasType',...
                'Direction', 'digital', 'OutputOnly', 'Bidirectional');
        end
    end
    ...
    methods (Access = protected)
        ...
        function measurementTypeDisplayText = getMeasurementTypeDisplayHook(~)
            measurementTypeDisplayText = 'OutputOnly';
        end
    end
