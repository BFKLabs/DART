classdef (Hidden) AnalogInputBridgeChannel < daq.ni.AnalogInputBridgeChannel & daq.ni.CompactDAQ.CommonAIChannelAttrib
% classdef (Hidden) CompactDAQAnalogInputBridgeChannel
    %AnalogInputBridgeChannel All settings & operations
    %for an NI CompactDAQ analog input bridge channel.
    ...
    methods(Hidden)
        ...
        function configureTask(obj,taskHandle)
            obj.configureTask@daq.ni.AnalogInputBridgeChannel(taskHandle);
    ...
    methods (Sealed, Access = protected)
        ...
        function channelPropertyBeingChangedHook(obj,propertyName,newValue)
            ...
            obj.channelPropertyBeingChangedHook@daq.ni.AnalogInputBridgeChannel(propertyName,newValue);
