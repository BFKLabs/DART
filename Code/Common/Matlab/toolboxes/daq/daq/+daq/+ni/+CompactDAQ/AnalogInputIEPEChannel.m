classdef (Hidden) AnalogInputIEPEChannel < daq.ni.AnalogInputIEPEChannel & daq.ni.CompactDAQ.CommonAIChannelAttrib
% classdef (Hidden) AnalogInputIEPEChannel
    %AnalogInputIEPEChannel All settings & operations
    %for an NI CompactDAQ analog input IEPE channel.
    ...
    methods(Hidden)
        function obj = AnalogInputIEPEChannel(session,deviceInfo,channelID)
            %AnalogInputIEPEChannel All settings &
            %operations for a CompactDAQ analog input IEPE channel
            %added to a session.
    ...
    methods(Hidden)
        ...
        function configureTask(obj,taskHandle)
            obj.configureTask@daq.ni.AnalogInputIEPEChannel(taskHandle);
    ...
    methods (Sealed, Access = protected)
        ...
        function channelPropertyBeingChangedHook(obj,propertyName,newValue)
            ...
            obj.channelPropertyBeingChangedHook@daq.ni.AnalogInputIEPEChannel(propertyName,newValue);
