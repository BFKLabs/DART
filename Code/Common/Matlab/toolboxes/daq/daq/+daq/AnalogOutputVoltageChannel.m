classdef (Hidden) AnalogOutputVoltageChannel < daq.AnalogOutputChannel
    ...
    methods(Hidden)
        function obj = AnalogOutputVoltageChannel(session,deviceInfo,id)
            %AnalogOutputVoltageChannel All settings & operations for an analog output voltage channel added to a session.
            ...
            obj@daq.AnalogOutputChannel(session,deviceInfo,id,'Volts');
    ...
    methods(Hidden)
        function channelDescriptionText = getChannelDescriptionHook(obj) %#ok<MANU>
            ...
            % operation
            channelDescriptionText = 'analog output voltage channel';
        end
    end
     methods
