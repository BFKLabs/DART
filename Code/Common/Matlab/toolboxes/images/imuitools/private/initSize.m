...
%   Copyright 1993-2012 The MathWorks, Inc.
  ...
  % Things may not settle down since the setting of positions before the
  % next line which changes units comes into effect. A drawnow forces
  % things to settle down. (See 982532).
  drawnow; 
