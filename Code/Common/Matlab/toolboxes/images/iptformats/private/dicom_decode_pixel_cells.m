...
if (info.PixelRepresentation == 1)
    ...
    switch (class(data))
    case 'int8'
        data = dicom_typecast(data, 'uint8');
    case 'int16'
        data = dicom_typecast(data, 'uint16');
    case 'int32'
        data = dicom_typecast(data, 'uint32');
    end
...
if (info.PixelRepresentation == 1)
    ...
    switch (class(data))
    case 'uint8'
        data = dicom_typecast(data, 'int8');
    case 'uint16'
        data = dicom_typecast(data, 'int16');
    case 'uint32'
        data = dicom_typecast(data, 'int32');
    end
