classdef gmdistribution < classreg.learning.internal.DisallowVectorOps
...
%      CovType      - Type of the component covariance matrices.
%      SharedCov    - A logical indicating whether all the component covariance are the same.
...
%      RegV         - The value of the 'Regularize' input parameter for FITGMDIST.
%
...
%   multivariate Gaussian components in the mixture distribution.
%
%   See also GMDISTRIBUTION.
      NDimensions = 0; 
 
%DistName Name of the distribution.
%   The DistName property specify the name of the distribution.'gaussian
...
%The PComponents property is a vector containing the mixing proportion of
%each component.
%
%   See also GMDISTRIBUTION.
...
%SharedCov Whether all the component covariance are the same.
%   The SharedCov property is true if all the component covariance matrices
%   are restricted to be the same (pooled cov); false otherwise.
%
%   See also GMDISTRIBUTION.
        SharedCov = [];
        
%CovType Type of the covariance matrices.
%   The CovType property is a string 'diagonal' if the component covariance
%   matrices are restricted to be diagonal; 'full' otherwise.
%
%   See also GMDISTRIBUTION.
        CovType = [];
        
%RegV The value of the 'Regularize' input parameter for FITGMDIST
%   The RegV property is the value supplied for the 'Regularize' input
%   parameter for FITGMDIST.
        RegV = 0;
 end
