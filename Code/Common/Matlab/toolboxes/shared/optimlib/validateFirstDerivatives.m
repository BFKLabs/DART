...
derivDiffError = MException('optimlib:validateFirstDerivatives:InvalidGrad', ...
    getString(message('optimlib:validateFirstDerivatives:InvalidGrad', ...
    derivCheck,options.FinDiffType,sprintf('%g',tol))));
...
X = reshape(X,sizes.xRows,sizes.xCols);
