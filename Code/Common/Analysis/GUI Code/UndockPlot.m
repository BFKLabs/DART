...
% set(hGUI.menuUndock,'enable','off');
set(hGUI.figFlyAnalysis,'visible','off'); pause(0.05); 
...
set(hPara,'Visible',eStr)
set(handles.menuPlot,'enable',eStr)
...
set(hGUI.figFlyAnalysis,'visible','on'); pause(0.05);
