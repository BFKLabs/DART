...
if (any(Type == [1 2]))
    ...
    set(handles.radioAlter1,'enable',eStr{1+ind(1)})
    set(handles.radioAlter2,'enable',eStr{1+ind(2)})        
    set(handles.radioAlter3,'enable',eStr{1+ind(3)})
    set(handles.radioAlter4,'enable',eStr{1+ind(4)})
    set(handles.buttonApply,'enable',eStr{1+any(ind)})
end
