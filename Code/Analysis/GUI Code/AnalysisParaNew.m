function varargout = AnalysisParaNew(varargin)
% Last Modified by GUIDE v2.5 13-Jan-2022 02:43:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @AnalysisParaNew_OpeningFcn, ...
                   'gui_OutputFcn',  @AnalysisParaNew_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before AnalysisParaNew is made visible.
function AnalysisParaNew_OpeningFcn(hObject, eventdata, handles, varargin)

% Choose default command line output for AnalysisParaNew
...
pObj = AnalysisParaClassNew(hObject,hGUI);
if pObj.isOK
...
% UIWAIT makes AnalysisParaNew wait for user response (see UIRESUME)
% uiwait(handles.figAnalysisPara);

% --- Outputs from this function are returned to the command line.
function varargout = AnalysisParaNew_OutputFcn(hObject, eventdata, handles) 
