classdef AnalysisPara < handle & AnalysisParaObj
    ...
    methods
        ...
        % --- object constructor
        function obj = AnalysisPara(hGUI)
...
%             resetObjPos(hPanelSR,'bottom',-dHght,1);   
        ...
        function resetGUIObjects(obj)
            ...
            set(obj.panelCalcPara,'position',[L 135 W H])
            set(obj.panelPlotPara,'position',[L 70 W H])
            set(obj.panelSubPara,'position',[L 50 W H2])
            set(obj.panelTimePara,'position',[L 30 W H2])
            set(obj.panelStimResPara,'position',[L 10 W H2])            
        ...
        function setupGUIObjects(obj,isInit)
            ...
            set(obj.textFuncName,'string',obj.pData.Func);
            resetObjExtent(obj.textFuncName)

            % sets the function description fields
            set(obj.textFuncDesc,'string',obj.pData.Name);
            resetObjExtent(obj.textFuncDesc)
            ...
            set(obj.textCalcReqd,'string','MOOOOOOOO');
            resetObjExtent(obj.textCalcReqd)
            resetRecalcObjProps(obj.hGUI,tStr,obj)

            % sets the function info field handles
            hObjF{1} = {obj.textFuncNameL,obj.textFuncName};
            hObjF{2} = {obj.textFuncDescL,obj.textFuncDesc};
            hObjF{3} = {obj.textCalcReqdL,obj.textCalcReqd};
            ...
            for i = 1:2
                if isempty(obj.hObj{i})
                     if i == 1
                        ...
                        setObjVisibility(obj.panelCalcPara,'off');
                    else
                        % deletes the subplot panel
                        setObjVisibility(obj.panelPlotPara,'off');            
                     end
            ...
            if isempty(obj.hObj{3})
                ...
                setObjVisibility(obj.panelTimePara,'off');
                setObjVisibility(obj.panelSubPara,'off'); 
                setObjVisibility(obj.panelStimResPara,'off'); 
                    ...
                    if isempty(obj.hObj{3}{i})               
                        switch (i)
                            case (1) 
                                % deletes the time panel
                                setObjVisibility(obj.panelTimePara,'off'); 
                                hPosNw = get(obj.panelTimePara,'position');
                                dy0 = -(obj.pOfs+hPosNw(4));
                                resetObjPos(obj.panelSubPara,'bottom',dy0,1);
                                
                            case (2) 
                                % deletes the subplot panel
                                setObjVisibility(...
                                    obj.panelSubPara,'off'); 
                                
                            case (3) 
                                % deletes the subplot panel
                                setObjVisibility(...
                                    obj.panelStimResPara,'off');                                 
                        end
                        ...
                        if ~isempty(i0)
                            ...
                            switch (i)
                                case (1) 
                                    % deletes the time panel
                                    setObjVisibility(obj.panelTimePara,0);                         
                                
                                case (2) 
                                    % deletes the subplot panel
                                    setObjVisibility(obj.panelSubPara,0);     
                                
                                case (3) 
                                    % deletes the subplot panel
                                    setObjVisibility(...
                                        obj.panelStimResPara,0);                                                         
                            end
            ...
            resetObjPos(obj.panelFuncInfo,'width',obj.wObjNw)
...
%             resetObjPos(obj.hFig,'bottom',50)
        ...
        function resetTimeLimitPanel(obj)
            ...
            resetObjPos(obj.panelTimePara,'width',obj.wObjNw)         
        ...
        function resetSubplotPanel(obj)
            ...
            resetObjPos(obj.panelSubPara,'width',obj.wObjNw)
            resetObjPos(obj.panelSubPara,'bottom',obj.yNew)
        ...
        function resetStimPanel(obj)
            ...
            resetObjPos(obj.panelStimResPara,'width',obj.wObjNw)
        ...
        function setupParaObjects(obj,Type)
            ...
            switch Type
                case ('Calc') 
                    % case is a calculation parameter
                    [hPB0,p,iType] = deal(obj.panelCalcPara,obj.pData.cP,1);        

                case ('Plot') 
                    % case is a plotting parameters
                    [hPB0,p,iType] = deal(obj.panelPlotPara,obj.pData.pP,2);        
        ...
        function setupTimePara(obj,p,indP)
            ...
            fPos = get(obj.hFig,'position');
            pPos = get(obj.panelTimePara,'position');
